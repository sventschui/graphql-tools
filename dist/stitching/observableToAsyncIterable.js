...
function observableToAsyncIterable(observable) {
    return __asyncGenerator(this, arguments, function observableToAsyncIterable_1() {
        ...
        var observer, subscription, value;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, __await(observer._buffer[0].promise)];
                case 3:
                    value = _a.sent();
...
exports.default = observableToAsyncIterable;
